...
the [kubectl drain](/docs/user-guide/kubectl/{{< param "version" >}}/#drain)
...
If you prefer not to use [kubectl drain](/docs/user-guide/kubectl/{{< param "version" >}}/#drain) (such as
